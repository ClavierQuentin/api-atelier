...
<div class="container">
    ...
    <form class="custom-form" action="{{ route('carrousel.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
        ...
        <div class="form-group m2">
            ...
            <input type="text" id="bouton" name="bouton" class="form-control @error('bouton') is-invalid @enderror" value="{{ old('bouton') }}">
        ...
        <div class="form-group m-2" id="divImage">
         ...
         <div class="form-group m2">
            ...
            <input type="url"  id="url" name="url" class="form-control @if ($errors->any()) is-invalid @endif" >
