...
Route::middleware('auth','role:admin')->group(function(){
    ...
    Route::put('deuxieme-banniere/delete/{deuxiemeBanniere}/{image}',[DeuxiemeBanniereController::class, 'deleteImage'])->name('delete.image');

    Route::delete('premiere-banniere/delete/{deuxiemeBanniere}',[DeuxiemeBanniereController::class, 'destroy'])->name('deuxiemeBanniere.delete'); //Route de suppression
